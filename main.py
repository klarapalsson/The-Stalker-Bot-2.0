...
from motor_controller import (
    forward, backwards, tank_turn_counterclockwise,
    tank_turn_clockwise, stop, disable_motors
)
...
def print_and_say(message):
    """
    Prints a message, updates AI camera status text, and speaks it aloud.
    """
    print("\n" + message)
    object_detection.video_status_text = message  # Update the status text in the AI detection module
...
def follow():
    ...
    """
    while True:
        direction, bias, speed, obstacle, person_area = object_detection.get_tracking_data()
...
if __name__ == "__main__":
    print("Starting person-following program. Press Ctrl+C to stop.")
    try:
        follow()
        ...
        print("Disabling motors and shutting down speaker...")
        disable_motors()
        speaker.stop_tts()
